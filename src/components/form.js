...
class Form extends Component {
    ...
    state = {
        ...
        AC_Count: this.siteData.AC_Count,
        AC1: this.siteData.AC1,
        Serial_Indoor_AC1: this.siteData.Serial_Indoor_AC1,
        Serial_Outdoor_AC1: this.siteData.Serial_Outdoor_AC1,
        Ton_AC1: this.siteData.Ton_AC1,
        AC2: this.siteData.AC2,
        Serial_Indoor_AC2: this.siteData.Serial_Indoor_AC2,
        Serial_Outdoor_AC2: this.siteData.Serial_Outdoor_AC2,
        Ton_AC2: this.siteData.Ton_AC2,
        Last_Pmr_Date: this.siteData.Last_Pmr_Date,
        PMR_By: this.siteData.PMR_By,
        Last_Fuel_Date: this.siteData.Last_Fuel_Date,
        Fuel_By: this.siteData.Fuel_By,
        ...
        Last_Part_Changed_Date: this.siteData.Last_Part_Changed_Date,
        Last_Part_Changed_By: this.siteData.Last_Part_Changed_By,
